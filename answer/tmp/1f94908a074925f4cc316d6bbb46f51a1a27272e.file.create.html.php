...
<div id="content">
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
        <div class="tab-main">
            ...
            <form id="_create_form" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'answer','a'=>'save','tid'=>$_smarty_tpl->getVariable('tid')->value,'sid'=>$_smarty_tpl->getVariable('sid')->value),$_smarty_tpl);?>
" method="post">
                <table class="formList">
                    <?php if ($_smarty_tpl->getVariable('current_action')->value=='bank'){?>
                    <input type="hidden" name="exam[exam_type]"  value="<?php echo $_smarty_tpl->getVariable('bank_exam_type')->value;?>
"/>
                    <?php }else{ ?>
                    <tr>
                    ...
                    <tr class="btnBox">
                        <td colspan="2">
                            ...
                            <span class="sBtn-cancel">
                                <a class="left" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'answer','a'=>$_smarty_tpl->getVariable('current_action')->value,'tid'=>$_smarty_tpl->getVariable('tid')->value,'sid'=>$_smarty_tpl->getVariable('sid')->value),$_smarty_tpl);?>
